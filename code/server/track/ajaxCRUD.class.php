    ...
    */
    ...
    function insertHeader($ajax_file = "ajaxCRUD.inc.php"){
		...
		if ($this->includeJQuery){
    		...
    		echo "<script type=\"text/javascript\" src=\"includes/jquery.validate.min.js\"></script>\n"; 		//rel 6 - added ability to validate forms fields
			echo "<script type=\"text/javascript\" src=\"includes/jquery.maskedinput.js\"></script>\n"; 								//rel 6 - ability to mask fields (http://digitalbush.com/projects/masked-input-plugin/)
			echo "<script src=\"" . $this->ajaxcrud_root . "includes/validation.js\" type=\"text/javascript\"></script>\n";
		}
        echo "<meta http-equiv=\"content-type\" content=\"text/html; charset=UTF-8\" />\n";
        echo "<script src=\"" . $this->ajaxcrud_root . "includes/javascript_functions.js\" type=\"text/javascript\"></script>\n";
        ...
        */
        ...
        if ($row_count > 0){
            ...
            */
            ...
            $table_html .= "<table align='center' class='table table-hover' name='table_" . $this->db_table . "' id='table_" . $this->db_table . "' cellspacing='" . $this->cellspacing . "' border=" . $this->border . ">\n";
