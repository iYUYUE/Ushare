...
class JpushClient
{
	 ...
	 * @param Strng $extras
	 */
	public  function sendNotificationByID($tag, $sendno, $send_description, 
			$mes_title, $mes_content, $platform, $extras='',$override_msg_id='')
	{
		$mes_type = 1;
		$receiver_type = 5;
	 ...
	 * @param Strng $extras
	 */
	public  function sendCustomMesByID($tag, $sendno, $send_description, 
			$mes_title, $mes_content, $platform, $extras='',$override_msg_id='')
	{
		$mes_type = 2;
		$receiver_type = 5;
